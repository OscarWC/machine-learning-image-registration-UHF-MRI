...
for i in range(1,n):
    ...
    fixed_image =  sitk.ReadImage(f"2D skull mesh/fixed_image.png", sitk.sitkFloat32)
    moving_image = sitk.ReadImage(f"2D skull mesh/00{i}_rt.png", sitk.sitkFloat32)
    ...
    text_file = open(f"2D skull mesh/reg_00{i}.txt", "a")
